...
client.once('ready', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, client.user.setPresence({ status: 'online', activity: { name: '!help for botCommands.commands!', type: 'STREAMING' } })];
            case 2:
                _a.sent();
                return [2 /*return*/];
            case 3:
...
client.on('message', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
    var command, args, x, commandData, cmdName, error_2, error_3, command, cmdName, error_4, error_5;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 16:
                ...
                return [4 /*yield*/, ((_b = CommandIndex_1.default.get(command)) === null || _b === void 0 ? void 0 : _b.function(msg, discordUser))];
            case 17:
                cmdName = _c.sent();
