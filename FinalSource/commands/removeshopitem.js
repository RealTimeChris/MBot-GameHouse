...
function execute(commandData, discordUser) {
    return __awaiter(this, void 0, void 0, function () {
        var commandReturnData, areWeInADM, doWeHaveAdminPermission, guildData, msgString_1, msgEmbed_1, msg, itemName, itemIndex, itemFound, x, msgString_2, msgEmbed_2, msg, msgString, msgEmbed, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    ...
                    if (!(itemFound === false)) return [3 /*break*/, 9];
