...
function execute(commandData, discordUser) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var commandReturnData_1, areWeInADM, areWeAllowed, guildData_1, guildMemberData_1, betAmountRegExp, msgString, msgEmbed, msg, betAmount_1, currencyAmount_1, msgString, msgEmbed, msg, newBetString_1, messageEmbed_1, newMessage_1, filter, error_1;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    ...
                    if (!(commandData.args[0] === undefined || !betAmountRegExp.test(commandData.args[0]) || parseInt(commandData.args[0], 10) < 1)) return [3 /*break*/, 7];
                ...
                case 7:
                    ...
                    if (!(betAmount_1 > currencyAmount_1)) return [3 /*break*/, 10];
